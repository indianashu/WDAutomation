...
public class ProductTest {
	...
	public void userSignin() throws Exception {
		...
		productCategoryPage.verifyConfirmationMsg("Saved Item Type Category Successfully");
		...
		productCategoryPage.clickSaveChangesButton();
		productCategoryPage.verifyConfirmationMsg("Saved Item Type Product Successfully");
		...
		productCategoryPage.clickSaveChangesButton();
		productCategoryPage.verifyConfirmationMsg("Saved Plan Type Category Successfully");
		//@TODO:- Please Uncomment when the bug-1874 is fixed 
		...
		productCategoryPage.clickAddPriceButton();
		productCategoryPage.clickSaveChangesButton();
		productCategoryPage.verifyConfirmationMsg("Saved Plan Type Product Successfully");

...
public class CurrencyPage extends BasePage {
	...
	public void verifyLabelConfirmationMessage() throws IOException {
		...
		JavaScriptExec.sleep();
		Assert.assertTrue(
				verifyLabelConfirmationMessage.getText().contains(BasePage.getCellData(xlsxName, sheetName, 4, 0)),
	...
	@FindBy(how = How.XPATH, using = "//*[@id='header']//span[@class='right-text']")
	...
	public void verifyChildCompanyName() throws IOException {
		...
		String ActualName = verifyChildCompanyName.getText();

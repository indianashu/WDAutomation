...
public class AddOnTestCase2Page extends BasePage {
	...
	public void subscriptionOfPlan() throws IOException {
		...
		verifyConfirmationMsg("Saved Subscription Order Successfully For AddOnCustomer2");
	}
	...
	public void consumptionOfPlan() throws IOException {
		...
		while(i <= 2){
			...
			enterChangeQty.sendKeys(BasePage.getCellData(xlsxName, sheetName, 11, i));
			...
			verifyConfirmationMsg("Saved Consumption Order Successfully For AddOnCustomer2 ");
